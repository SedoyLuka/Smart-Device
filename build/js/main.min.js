...
/* harmony import */ var _modules_show_more__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/show-more */ "./js/modules/show-more.js");
/* harmony import */ var _modules_show_more__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_show_more__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _modules_tel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/tel */ "./js/modules/tel.js");
/* harmony import */ var _modules_tel__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_tel__WEBPACK_IMPORTED_MODULE_6__);
...
var accordionParts = document.querySelectorAll(".footer__button-wrapper");
var acoordionContent = document.querySelectorAll(".footer__accordion-content");
var breakpoint = window.matchMedia("(min-width:768px)");
var accordionButtons = document.querySelectorAll(".footer__section-title");
var hideAccordionContent = function hideAccordionContent(action) {
  acoordionContent.forEach(function (el) {
    el.classList[action]("visually-hidden");
  });
...
var onPartClick = function onPartClick(evt) {
  var content = evt.currentTarget.closest("section").querySelector(".footer__accordion-content");
  var button = evt.currentTarget.closest("section").querySelector(".footer__section-title");
...
var breakpointChecker = function breakpointChecker() {
  if (!breakpoint.matches) {
    hideAccordionContent("add");
    accordionParts.forEach(function (el) {
...
document.querySelectorAll('a[href^="#"').forEach(function (link) {
  link.addEventListener('click', function (e) {
    ...
    var topOffset = document.querySelector('.main-header').offsetHeight;
...
if (button) {
  var text = document.querySelector('.info__description-container');
...
window.addEventListener('DOMContentLoaded', function () {
  [].forEach.call(document.querySelectorAll('input[type="tel"]'), function (input) {
    ...
    function mask(event) {
      ...
      var i = 0;
      var def = matrix.replace(/\D/g, '');
      var vale = input.value.replace(/\D/g, '');
      var newValue = matrix.replace(/[_\d]/g, function (arr) {
      ...
      var reg = matrix.substr(0, input.value.length).replace(/_+/g, function (arr) {
